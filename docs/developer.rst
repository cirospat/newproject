...
* \ |LINK30|\  my google maps

* \ |LINK31|\  (pagina FB con mappe su Palermo)

* \ |LINK32|\  (mappe varie di Ciro)

* \ |LINK33|\  (contenitore di oltre 100 mappe su Palermo, su Petrusino)

* \ |LINK34|\  (sito mappe di Palermo utili a turisti)

* \ |LINK35|\  (OMIRA su Umap cirospat) 

* \ |LINK36|\  elezioni2017_Palermo da Guenter Richter

* \ |LINK37|\  e relativo bot telegram #rifiutocivico

* \ |LINK38|\  mapillary cirospat

* \ |LINK39|\  Palermo su mapillary

* \ |LINK40|\  Palermo airbnb gen_2018 (Gianni Vitrano)
...
* \ |LINK41|\  (GBVitrano Palermo IGM 1:25000)

* \ |LINK42|\  carta tecnica comune Palermo

* \ |LINK43|\  (GBVitrano Omira 1:5000)

* \ |LINK44|\   PRG2025 (su Petrusino)

* \ |LINK45|\  (elenco mappe 2-3D di GBVitrano su Github SiciliaHub)

* \ |LINK46|\   (Hubsicilia - Omira Irta e Sas con OSM e RealVista su Gitub SiciliaHub, con metadati mappa su barra laterale)

* \ |LINK47|\  (variante general eal PRG 2004 con cerchio)

* \ |LINK48|\  (catasto centro storico 1887 con cerchio)

* \ |LINK49|\  (PRG scehma masima su PRG 2004 con cerchio)

* \ |LINK50|\    \ |LINK51|\    (Piano protezione civile Palermo)

* \ |LINK52|\   (stile petrusino)

* \ |LINK53|\   (stile petrusino, ultimo gen 2018) - hub di diverse mappe di Palermo a cura di GBVitrano iniziato gli ultimi giorni di dic. del 2017
...
\ |LINK54|\  (che preferisco) 

\ |LINK55|\  (intramontabile) 

\ |LINK56|\  (questo però è un plugin per wordpress) 
...
The \ |LINK60|\  function converts it to the required format for the Query formula by specifying a format of "yyyy-mm-dd":
...
* lista di tiles per sfondi   \ |LINK62|\  

* tiles vari da usare  \ |LINK63|\  

* satellite tile ESRI - World Imagery \ |LINK64|\  

* satellite tile Google \ |LINK65|\  

* tile con sfondo satellite da mapbox/satellite-v9 con API: \ |LINK66|\   (senza nomi strade)

* \ |LINK67|\  (con nomi strade)

* SERVIZIO ONLINE CREAZIONE DI TILES DA IMMAGINI  Mapwarper \ |LINK68|\  

* \ |LINK69|\  tile: https://api.mapbox.com/styles/v1/rplln/cjix2cv5l83yz2rmne9icvusx/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoicnBsbG4iLCJhIjoiY2ppeDI5ZTByMDVtMzN1cDRxZWlzamwzcyJ9.Yn6OjT0SStL2tffNloZrdg
...
video embedding = {{{\ |LINK70|\ }}}

link con testo = [[\ |LINK71|\ |testo del link]] 

immagine = {{\ |LINK72|\ |larghezza}} Immagine 

link a url con icona cliccabile = [[\ |LINK73|\ }}]]

ICONE MAPPE = \ |LINK74|\  

GOOGLEMAPS = <iframe width='100%' height='500' src="http....   "></iframe>

URL ENCODER E DECODER = \ |LINK75|\  

POST IMAGE DA LINKARE SU UMAP: \ |LINK76|\  

Icone mappe \ |LINK77|\  ccbysa
...
Video breve per alimentare in modo facile uMap da un foglio elettronico su Google Drive, by Andrea Borruso \ |LINK78|\ 

Tutorial per fare mappe alimentate da google spreadsheet = \ |LINK79|\  
...
.. _h18306615649e113899645c203d73:

\ |LINK80|\  e \ |LINK81|\  UMAP AVVISI POLIZIA MUNICIPALE PA - VISUALIZZARE MAPPE CON INFO SU DATA ODIERNA
-----------------------------------------------------------------------------------------------------------
...
⇒ \ |LINK82|\  plug in come componente aggiuntivo da installare su spreadsheet di Google. Sfrutta API di Google e quindi i dati delle coordinate geografiche sono riusabili solo su mappe Google.
...
dove A2 è la colonna dove è contenuto l'indirizzo. \ |LINK83|\ .


|REPLACE11|

* \ |LINK84|\  con Openstreetmap tramite OnData

* \ |LINK85|\   con Openstreetmap

* \ |LINK86|\  con Openstreetmap

* \ |LINK87|\  con Openstreetmap

* \ |LINK88|\  con Googlemap

* \ |LINK89|\  by GBVitrano con API Google

* \ |LINK90|\  by GBVitrano con API Google

* \ |LINK91|\  con le API di Google

    * \ |LINK92|\  con API Google

* \ |LINK93|\  (google e bing) 

* \ |LINK94|\  con API di Mapquest

* \ |LINK95|\  API Mapquest per geocoding (cirospat - caneclaudia2volte)

* \ |LINK96|\  location helper in versione demo di Mapbox
...
* \ |LINK98|\  (mappa con grafici e dati su sensore mio)
...
just a simple guide for getting started with git. \ |LINK99|\ 
...
\ |LINK102|\  un articolo per capire un po

\ |LINK103|\  corso online strutturato bene per utenti con nozioni zero di intelligenza artificiale
...
* \ |LINK105|\  editor online sulla falsa riga di Google spreadsheet
...
* \ |LINK112|\  il mio genratore di feed RSS

* \ |LINK113|\  - \ |LINK114|\  per costruire Feed per gli eventi Feltrinelli di Palermo
...
* \ |LINK122|\  — si tratta di un altro servizio Web gratuito e che non necessita di registrazione e permette di intervenire sui documenti PDF unendoli, oltre che convertendoli, dividendoli, alleggerendoli, sbloccandoli ecc. Non applica limitazioni per quel che concerne il peso massimo dei file.

* \ |LINK123|\  — è un’altra soluzione per unire i file PDF via Web e tramite la quale è eventualmente possibile apportare varie ulteriori modifiche ai documenti caricati. È gratis, non richiede registrazione e non pone limiti per l’upload.

\ |STYLE10|\ 

\ |STYLE11|\ . Si tratta, infatti, di un’app che consente di visualizzare i file PDF e intervenire su di essi in vari modi, andandoli a convertire, unire ecc. È gratuita e facile da usare. Per effettuarne il download sul tuo dispositivo, accedi alla \ |LINK124|\ 
...
:guilabel:`Queste ed altre indicazioni per Read the Docs si tovano anche a` \ |LINK126|\  
...
:download:\`Questo link è per il download <\ |LINK127|\ >\`.

si scrive così: ``:download:`Questo link è per il download <\ |LINK128|\ >```
