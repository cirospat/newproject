...
:guilabel:`trovare la pagina esatta in un pdf online`: nel web è \ |LINK3|\  cioè dopo :class:`.pdf` digitare :class:`.#page=4` dove dopo :class:`=` si scrive il numero della pagina alla quale si vuole che venga visualizzata direttamente all'apertura del file in formato ``pdf``
