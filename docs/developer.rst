...
* ODS Totò Fiandaca e GB Vitrano: \ |LINK9|\ 

* Andrea Borruso: \ |LINK10|\ 

* Associazione OnData: \ |LINK11|\ 

* Riccardo Borchi: \ |LINK12|\ 

* Governo: \ |LINK13|\ 

* Bot Telegram COVID-19 Italia Aggiornamento: \ |LINK14|\  

* Protezione Civile Nazionale: \ |LINK15|\ 

* Protezione Civile Nazionale: \ |LINK16|\ 

* Protezione Civile Sicilia: \ |LINK17|\ 

* Piersoft Paolicelli: \ |LINK18|\ 
...
:guilabel:`trovare la pagina esatta in un pdf online`: nel web è \ |LINK20|\  cioè dopo :class:`.pdf` digitare :class:`.#page=4` dove dopo :class:`=` si scrive il numero della pagina che si vuole venga visualizzata direttamente all'apertura del file ``pdf`` online
...
* \ |LINK24|\   Recording Limit 5 mins free version

* \ |LINK25|\  

* \ |LINK26|\  limited features in free version
...
Si aprirà la finestra \ |STYLE3|\  (→ \ |LINK29|\ ).

Nella casella \ |STYLE4|\  digitiamo ``diskpart``

Facciamo clic su \ |STYLE5|\ .

Si aprirà la finestra \ |STYLE6|\  dell’account utente (→ \ |LINK30|\ ) facciamo clic su \ |STYLE7|\  o su Continua.
...
Per nascondere nuovamente la partizione dobbiamo rimuovere la lettera di unità. Per sapere come fare leggiamo → \ |LINK31|\ .
...
+==========================================================================================================================================================================================+==========================================================================================+
|fare presentazioni in stile STAR WARS                                                                                                                                                     |\ |LINK32|\                                                                               |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
|OCR jpg to docx                                                                                                                                                                           |\ |LINK33|\                                                                               |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
...
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
|icone material design Google                                                                                                                                                              |\ |LINK34|\                                                                               |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
|webservice per la trascrizione testuale di audio                                                                                                                                          |\ |LINK35|\                                                                               |
|                                                                                                                                                                                          |                                                                                          |
|con plugin per chrome                                                                                                                                                                     |\ |LINK36|\                                                                               |
|                                                                                                                                                                                          |                                                                                          |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
|\ |STYLE22|\  funzioni su Fogli Google spreadsheet                                                                                                                                        |\ |LINK37|\                                                                               |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
|Markup Validation Service                                                                                                                                                                 |\ |LINK38|\                                                                               |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
|Web accessibility Contrast Checker                                                                                                                                                        |\ |LINK39|\                                                                               |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
|Web Developer Toolbar Chrome                                                                                                                                                              |\ |LINK40|\                                                                               |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
|Accessibility of a PDF Document                                                                                                                                                           |\ |LINK41|\                                                                               |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
|Guida alla sintassi del linguaggio  ``rst``                                                                                                                                               |\ |LINK42|\                                                                               |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
|Editor di testo per linguaggio ``rst``                                                                                                                                                    |\ |LINK43|\                                                                               |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
|Editor per le tabelle in diversi linguaggi (Latex, Balsamiq, BBCode, Comma separated values, HTML, JSON, Markdown, Mathematica, Plain text, reStructuredText, SQL, Wiki markup, No output)|\ |LINK44|\                                                                               |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
|No text editor                                                                                                                                                                            |\ |LINK45|\                                                                               |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
|Markdown Table Generator                                                                                                                                                                  |\ |LINK46|\                                                                               |
|                                                                                                                                                                                          |                                                                                          |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
|Editor per le tabelle in diversi linguaggi                                                                                                                                                |\ |LINK47|\                                                                               |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
|Convertire file da altri formati in CSV o da CSV in altri formati                                                                                                                         |\ |LINK48|\                                                                               |
+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------+
...
* \ |LINK51|\  my google maps

* \ |LINK52|\  (pagina FB con mappe su Palermo)

* \ |LINK53|\  (mappe varie di Ciro)

* \ |LINK54|\  (contenitore di oltre 100 mappe su Palermo, su Petrusino)

* \ |LINK55|\  (sito mappe di Palermo utili a turisti)

* \ |LINK56|\  (OMIRA su Umap cirospat) 

* \ |LINK57|\  elezioni2017_Palermo da Guenter Richter

* \ |LINK58|\  e relativo bot telegram #rifiutocivico

* \ |LINK59|\  mapillary cirospat

* \ |LINK60|\  Palermo su mapillary

* \ |LINK61|\  Palermo airbnb gen_2018 (Gianni Vitrano)
...
* \ |LINK62|\  (GBVitrano Palermo IGM 1:25000)

* \ |LINK63|\  carta tecnica comune Palermo

* \ |LINK64|\  (GBVitrano Omira 1:5000)

* \ |LINK65|\   PRG2025 (su Petrusino)

* \ |LINK66|\  (elenco mappe 2-3D di GBVitrano su Github SiciliaHub)

* \ |LINK67|\   (Hubsicilia - Omira Irta e Sas con OSM e RealVista su Gitub SiciliaHub, con metadati mappa su barra laterale)

* \ |LINK68|\  (variante general eal PRG 2004 con cerchio)

* \ |LINK69|\  (catasto centro storico 1887 con cerchio)

* \ |LINK70|\  (PRG scehma masima su PRG 2004 con cerchio)

* \ |LINK71|\    \ |LINK72|\    (Piano protezione civile Palermo)

* \ |LINK73|\   (stile petrusino)

* \ |LINK74|\   (stile petrusino, ultimo gen 2018) - hub di diverse mappe di Palermo a cura di GBVitrano iniziato gli ultimi giorni di dic. del 2017
...
\ |LINK75|\  (che preferisco) 

\ |LINK76|\  (intramontabile) 

\ |LINK77|\  (questo però è un plugin per wordpress) 
...
The \ |LINK81|\  function converts it to the required format for the Query formula by specifying a format of "yyyy-mm-dd":
...
* lista di tiles per sfondi   \ |LINK83|\  

* tiles vari da usare  \ |LINK84|\  

* satellite tile ESRI - World Imagery \ |LINK85|\  

* satellite tile Google \ |LINK86|\  

* tile con sfondo satellite da mapbox/satellite-v9 con API: \ |LINK87|\   (senza nomi strade)

* \ |LINK88|\  (con nomi strade)

* SERVIZIO ONLINE CREAZIONE DI TILES DA IMMAGINI  Mapwarper \ |LINK89|\  

* \ |LINK90|\  tile: https://api.mapbox.com/styles/v1/rplln/cjix2cv5l83yz2rmne9icvusx/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoicnBsbG4iLCJhIjoiY2ppeDI5ZTByMDVtMzN1cDRxZWlzamwzcyJ9.Yn6OjT0SStL2tffNloZrdg
...
video embedding = {{{\ |LINK91|\ }}}

link con testo = [[\ |LINK92|\ |testo del link]] 

immagine = {{\ |LINK93|\ |larghezza}} Immagine 

link a url con icona cliccabile = [[\ |LINK94|\ }}]]

ICONE MAPPE = \ |LINK95|\  

GOOGLEMAPS = <iframe width='100%' height='500' src="http....   "></iframe>

URL ENCODER E DECODER = \ |LINK96|\  

POST IMAGE DA LINKARE SU UMAP: \ |LINK97|\  

Icone mappe \ |LINK98|\  ccbysa
...
Video breve per alimentare in modo facile uMap da un foglio elettronico su Google Drive, by Andrea Borruso \ |LINK99|\ 

Tutorial per fare mappe alimentate da google spreadsheet = \ |LINK100|\  
...
.. _h786438262c39562b6a2a307b557d1463:

\ |LINK101|\  e \ |LINK102|\  UMAP AVVISI POLIZIA MUNICIPALE PA - VISUALIZZARE MAPPE CON INFO SU DATA ODIERNA
-------------------------------------------------------------------------------------------------------------
...
⇒ \ |LINK103|\  plug in come componente aggiuntivo da installare su spreadsheet di Google. Sfrutta API di Google e quindi i dati delle coordinate geografiche sono riusabili solo su mappe Google.
...
dove A2 è la colonna dove è contenuto l'indirizzo. \ |LINK104|\ .


|REPLACE10|

* \ |LINK105|\  con Openstreetmap tramite OnData

* \ |LINK106|\   con Openstreetmap

* \ |LINK107|\  con Openstreetmap

* \ |LINK108|\  con Openstreetmap

* \ |LINK109|\  con Googlemap

* \ |LINK110|\  by GBVitrano con API Google

* \ |LINK111|\  by GBVitrano con API Google

* \ |LINK112|\  con le API di Google

    * \ |LINK113|\  con API Google

* \ |LINK114|\  (google e bing) 

* \ |LINK115|\  con API di Mapquest

* \ |LINK116|\  API Mapquest per geocoding (cirospat - caneclaudia2volte)

* \ |LINK117|\  location helper in versione demo di Mapbox
...
* \ |LINK119|\  (mappa con grafici e dati su sensore mio)
...
just a simple guide for getting started with git. \ |LINK120|\ 
...
\ |LINK123|\  un articolo per capire un po

\ |LINK124|\  corso online strutturato bene per utenti con nozioni zero di intelligenza artificiale
...
* \ |LINK126|\  editor online sulla falsa riga di Google spreadsheet
...
* \ |LINK133|\  il mio genratore di feed RSS

* \ |LINK134|\  - \ |LINK135|\  per costruire Feed per gli eventi Feltrinelli di Palermo
...
* PDFTK Builder \ |LINK140|\  

* Online2PDF \ |LINK141|\  

* \ |LINK142|\  — servizio Web gratuito e che non richiede registrazioni. Permette di unire e modificare i file PDF in vari modi. Da notare che non consente di caricare file aventi un peso superiore ai 100 MB. Eventualmente, però, è possibile aggirare questa limitazione passando a uno dei piani a pagamento (con costi a partire da 6 euro/mese), i quali consentono di sbloccare anche altre funzionalità extra.

* \ |LINK143|\  — si tratta di un altro servizio Web gratuito e che non necessita di registrazione e permette di intervenire sui documenti PDF unendoli, oltre che convertendoli, dividendoli, alleggerendoli, sbloccandoli ecc. Non applica limitazioni per quel che concerne il peso massimo dei file.

* \ |LINK144|\  — è un’altra soluzione per unire i file PDF via Web e tramite la quale è eventualmente possibile apportare varie ulteriori modifiche ai documenti caricati. È gratis, non richiede registrazione e non pone limiti per l’upload.

\ |STYLE32|\ 

\ |STYLE33|\ . Si tratta, infatti, di un’app che consente di visualizzare i file PDF e intervenire su di essi in vari modi, andandoli a convertire, unire ecc. È gratuita e facile da usare. Per effettuarne il download sul tuo dispositivo, accedi alla \ |LINK145|\ 
...
:guilabel:`Queste ed altre indicazioni per Read the Docs si tovano anche a` \ |LINK147|\  
...
:download:\`Questo link è per il download <\ |LINK148|\ >\`.

si scrive così: ``:download:`Questo link è per il download <\ |LINK149|\ >```
