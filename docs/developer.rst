...
* \ |LINK50|\  my google maps

* \ |LINK51|\  (pagina FB con mappe su Palermo)

* \ |LINK52|\  (mappe varie di Ciro)

* \ |LINK53|\  (contenitore di oltre 100 mappe su Palermo, su Petrusino)

* \ |LINK54|\  (sito mappe di Palermo utili a turisti)

* \ |LINK55|\  (OMIRA su Umap cirospat) 

* \ |LINK56|\  elezioni2017_Palermo da Guenter Richter

* \ |LINK57|\  e relativo bot telegram #rifiutocivico

* \ |LINK58|\  mapillary cirospat

* \ |LINK59|\  Palermo su mapillary

* \ |LINK60|\  Palermo airbnb gen_2018 (Gianni Vitrano)
...
* \ |LINK61|\  (GBVitrano Palermo IGM 1:25000)

* \ |LINK62|\  carta tecnica comune Palermo

* \ |LINK63|\  (GBVitrano Omira 1:5000)

* \ |LINK64|\   PRG2025 (su Petrusino)

* \ |LINK65|\  (elenco mappe 2-3D di GBVitrano su Github SiciliaHub)

* \ |LINK66|\   (Hubsicilia - Omira Irta e Sas con OSM e RealVista su Gitub SiciliaHub, con metadati mappa su barra laterale)

* \ |LINK67|\  (variante general eal PRG 2004 con cerchio)

* \ |LINK68|\  (catasto centro storico 1887 con cerchio)

* \ |LINK69|\  (PRG scehma masima su PRG 2004 con cerchio)

* \ |LINK70|\    \ |LINK71|\    (Piano protezione civile Palermo)

* \ |LINK72|\   (stile petrusino)

* \ |LINK73|\   (stile petrusino, ultimo gen 2018) - hub di diverse mappe di Palermo a cura di GBVitrano iniziato gli ultimi giorni di dic. del 2017
...
\ |LINK74|\  (che preferisco) 

\ |LINK75|\  (intramontabile) 

\ |LINK76|\  (questo però è un plugin per wordpress) 
...
The \ |LINK80|\  function converts it to the required format for the Query formula by specifying a format of "yyyy-mm-dd":
...
* lista di tiles per sfondi   \ |LINK82|\  

* tiles vari da usare  \ |LINK83|\  

* satellite tile ESRI - World Imagery \ |LINK84|\  

* satellite tile Google \ |LINK85|\  

* tile con sfondo satellite da mapbox/satellite-v9 con API: \ |LINK86|\   (senza nomi strade)

* \ |LINK87|\  (con nomi strade)

* SERVIZIO ONLINE CREAZIONE DI TILES DA IMMAGINI  Mapwarper \ |LINK88|\  

* \ |LINK89|\  tile: https://api.mapbox.com/styles/v1/rplln/cjix2cv5l83yz2rmne9icvusx/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoicnBsbG4iLCJhIjoiY2ppeDI5ZTByMDVtMzN1cDRxZWlzamwzcyJ9.Yn6OjT0SStL2tffNloZrdg
...
video embedding = {{{\ |LINK90|\ }}}

link con testo = [[\ |LINK91|\ |testo del link]] 

immagine = {{\ |LINK92|\ |larghezza}} Immagine 

link a url con icona cliccabile = [[\ |LINK93|\ }}]]

ICONE MAPPE = \ |LINK94|\  

GOOGLEMAPS = <iframe width='100%' height='500' src="http....   "></iframe>

URL ENCODER E DECODER = \ |LINK95|\  

POST IMAGE DA LINKARE SU UMAP: \ |LINK96|\  

Icone mappe \ |LINK97|\  ccbysa
...
Video breve per alimentare in modo facile uMap da un foglio elettronico su Google Drive, by Andrea Borruso \ |LINK98|\ 

Tutorial per fare mappe alimentate da google spreadsheet = \ |LINK99|\  
...
.. _h75c797737527c3a50407b611203e39:

\ |LINK100|\  e \ |LINK101|\  UMAP AVVISI POLIZIA MUNICIPALE PA - VISUALIZZARE MAPPE CON INFO SU DATA ODIERNA
-------------------------------------------------------------------------------------------------------------
...
⇒ \ |LINK102|\  plug in come componente aggiuntivo da installare su spreadsheet di Google. Sfrutta API di Google e quindi i dati delle coordinate geografiche sono riusabili solo su mappe Google.
...
dove A2 è la colonna dove è contenuto l'indirizzo. \ |LINK103|\ .


|REPLACE10|

* \ |LINK104|\  con Openstreetmap tramite OnData

* \ |LINK105|\   con Openstreetmap

* \ |LINK106|\  con Openstreetmap

* \ |LINK107|\  con Openstreetmap

* \ |LINK108|\  con Googlemap

* \ |LINK109|\  by GBVitrano con API Google

* \ |LINK110|\  by GBVitrano con API Google

* \ |LINK111|\  con le API di Google

    * \ |LINK112|\  con API Google

* \ |LINK113|\  (google e bing) 

* \ |LINK114|\  con API di Mapquest

* \ |LINK115|\  API Mapquest per geocoding (cirospat - caneclaudia2volte)

* \ |LINK116|\  location helper in versione demo di Mapbox
...
* \ |LINK118|\  (mappa con grafici e dati su sensore mio)
...
just a simple guide for getting started with git. \ |LINK119|\ 
...
\ |LINK122|\  un articolo per capire un po

\ |LINK123|\  corso online strutturato bene per utenti con nozioni zero di intelligenza artificiale
...
* \ |LINK125|\  editor online sulla falsa riga di Google spreadsheet
...
* \ |LINK132|\  il mio genratore di feed RSS

* \ |LINK133|\  - \ |LINK134|\  per costruire Feed per gli eventi Feltrinelli di Palermo
...
* PDFTK Builder \ |LINK139|\  

* Online2PDF \ |LINK140|\  

* \ |LINK141|\  — servizio Web gratuito e che non richiede registrazioni. Permette di unire e modificare i file PDF in vari modi. Da notare che non consente di caricare file aventi un peso superiore ai 100 MB. Eventualmente, però, è possibile aggirare questa limitazione passando a uno dei piani a pagamento (con costi a partire da 6 euro/mese), i quali consentono di sbloccare anche altre funzionalità extra.

* \ |LINK142|\  — si tratta di un altro servizio Web gratuito e che non necessita di registrazione e permette di intervenire sui documenti PDF unendoli, oltre che convertendoli, dividendoli, alleggerendoli, sbloccandoli ecc. Non applica limitazioni per quel che concerne il peso massimo dei file.

* \ |LINK143|\  — è un’altra soluzione per unire i file PDF via Web e tramite la quale è eventualmente possibile apportare varie ulteriori modifiche ai documenti caricati. È gratis, non richiede registrazione e non pone limiti per l’upload.

\ |STYLE32|\ 

\ |STYLE33|\ . Si tratta, infatti, di un’app che consente di visualizzare i file PDF e intervenire su di essi in vari modi, andandoli a convertire, unire ecc. È gratuita e facile da usare. Per effettuarne il download sul tuo dispositivo, accedi alla \ |LINK144|\ 
...
:guilabel:`Queste ed altre indicazioni per Read the Docs si tovano anche a` \ |LINK146|\  
...
:download:\`Questo link è per il download <\ |LINK147|\ >\`.

si scrive così: ``:download:`Questo link è per il download <\ |LINK148|\ >```
