...
:guilabel:`trovare la pagina esatta in un pdf online`: nel web è \ |LINK11|\  cioè dopo :class:`.pdf` digitare :class:`.#page=4` dove dopo :class:`=` si scrive il numero della pagina che si vuole venga visualizzata direttamente all'apertura del file ``pdf`` online
...
+-------------------------------------------------+------------------------------------------------------------------------------------------+
|icone material design Google                     |\ |LINK12|\                                                                               |
+-------------------------------------------------+------------------------------------------------------------------------------------------+
|webservice per la trascrizione testuale di audio |\ |LINK13|\                                                                               |
|                                                 |                                                                                          |
|con plugin per chrome                            |\ |LINK14|\                                                                               |
|                                                 |                                                                                          |
+-------------------------------------------------+------------------------------------------------------------------------------------------+
|\ |STYLE0|\  funzioni su Fogli Google spreadsheet|\ |LINK15|\                                                                               |
+-------------------------------------------------+------------------------------------------------------------------------------------------+
|Markup Validation Service                        |\ |LINK16|\                                                                               |
+-------------------------------------------------+------------------------------------------------------------------------------------------+
|Web accessibility Contrast Checker               |\ |LINK17|\                                                                               |
+-------------------------------------------------+------------------------------------------------------------------------------------------+
|Web Developer Toolbar Chrome                     |\ |LINK18|\                                                                               |
+-------------------------------------------------+------------------------------------------------------------------------------------------+
|Accessibility of a PDF Document                  |\ |LINK19|\                                                                               |
+-------------------------------------------------+------------------------------------------------------------------------------------------+
...
* \ |LINK22|\  my google maps

* \ |LINK23|\  (pagina FB con mappe su Palermo)

* \ |LINK24|\  (mappe varie di Ciro)

* \ |LINK25|\  (contenitore di oltre 100 mappe su Palermo, su Petrusino)

* \ |LINK26|\  (sito mappe di Palermo utili a turisti)

* \ |LINK27|\  (OMIRA su Umap cirospat) 

* \ |LINK28|\  elezioni2017_Palermo da Guenter Richter

* \ |LINK29|\  e relativo bot telegram #rifiutocivico

* \ |LINK30|\  mapillary cirospat

* \ |LINK31|\  Palermo su mapillary

* \ |LINK32|\  Palermo airbnb gen_2018 (Gianni Vitrano)
...
* \ |LINK33|\  (GBVitrano Palermo IGM 1:25000)

* \ |LINK34|\  carta tecnica comune Palermo

* \ |LINK35|\  (GBVitrano Omira 1:5000)

* \ |LINK36|\   PRG2025 (su Petrusino)

* \ |LINK37|\  (elenco mappe 2-3D di GBVitrano su Github SiciliaHub)

* \ |LINK38|\   (Hubsicilia - Omira Irta e Sas con OSM e RealVista su Gitub SiciliaHub, con metadati mappa su barra laterale)

* \ |LINK39|\  (variante general eal PRG 2004 con cerchio)

* \ |LINK40|\  (catasto centro storico 1887 con cerchio)

* \ |LINK41|\  (PRG scehma masima su PRG 2004 con cerchio)

* \ |LINK42|\    \ |LINK43|\    (Piano protezione civile Palermo)

* \ |LINK44|\   (stile petrusino)

* \ |LINK45|\   (stile petrusino, ultimo gen 2018) - hub di diverse mappe di Palermo a cura di GBVitrano iniziato gli ultimi giorni di dic. del 2017
...
\ |LINK46|\  (che preferisco) 

\ |LINK47|\  (intramontabile) 

\ |LINK48|\  (questo però è un plugin per wordpress) 
...
The \ |LINK52|\  function converts it to the required format for the Query formula by specifying a format of "yyyy-mm-dd":
...
* lista di tiles per sfondi   \ |LINK54|\  

* tiles vari da usare  \ |LINK55|\  

* satellite tile ESRI - World Imagery \ |LINK56|\  

* satellite tile Google \ |LINK57|\  

* tile con sfondo satellite da mapbox/satellite-v9 con API: \ |LINK58|\   (senza nomi strade)

* \ |LINK59|\  (con nomi strade)

* SERVIZIO ONLINE CREAZIONE DI TILES DA IMMAGINI  Mapwarper \ |LINK60|\  

* \ |LINK61|\  tile: https://api.mapbox.com/styles/v1/rplln/cjix2cv5l83yz2rmne9icvusx/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoicnBsbG4iLCJhIjoiY2ppeDI5ZTByMDVtMzN1cDRxZWlzamwzcyJ9.Yn6OjT0SStL2tffNloZrdg
...
video embedding = {{{\ |LINK62|\ }}}

link con testo = [[\ |LINK63|\ |testo del link]] 

immagine = {{\ |LINK64|\ |larghezza}} Immagine 

link a url con icona cliccabile = [[\ |LINK65|\ }}]]

ICONE MAPPE = \ |LINK66|\  

GOOGLEMAPS = <iframe width='100%' height='500' src="http....   "></iframe>

URL ENCODER E DECODER = \ |LINK67|\  

POST IMAGE DA LINKARE SU UMAP: \ |LINK68|\  

Icone mappe \ |LINK69|\  ccbysa
...
Video breve per alimentare in modo facile uMap da un foglio elettronico su Google Drive, by Andrea Borruso \ |LINK70|\ 

Tutorial per fare mappe alimentate da google spreadsheet = \ |LINK71|\  
...
.. _h64a53432033534b42587a527a18545:

\ |LINK72|\  e \ |LINK73|\  UMAP AVVISI POLIZIA MUNICIPALE PA - VISUALIZZARE MAPPE CON INFO SU DATA ODIERNA
-----------------------------------------------------------------------------------------------------------
...
⇒ \ |LINK74|\  plug in come componente aggiuntivo da installare su spreadsheet di Google. Sfrutta API di Google e quindi i dati delle coordinate geografiche sono riusabili solo su mappe Google.
...
dove A2 è la colonna dove è contenuto l'indirizzo. \ |LINK75|\ .


|REPLACE7|

* \ |LINK76|\  con Openstreetmap tramite OnData
...
* \ |LINK80|\  con Googlemap

* \ |LINK81|\  by GBVitrano con API Google

* \ |LINK82|\  by GBVitrano con API Google

* \ |LINK83|\  con le API di Google

    * \ |LINK84|\  con API Google

* \ |LINK85|\  (google e bing) 

* \ |LINK86|\  con API di Mapquest

* \ |LINK87|\  API Mapquest per geocoding (cirospat - caneclaudia2volte)

* \ |LINK88|\  location helper in versione demo di Mapbox
...
* \ |LINK90|\  (mappa con grafici e dati su sensore mio)
...
just a simple guide for getting started with git. \ |LINK91|\ 
...
\ |LINK94|\  un articolo per capire un po

\ |LINK95|\  corso online strutturato bene per utenti con nozioni zero di intelligenza artificiale
...
* \ |LINK97|\  editor online sulla falsa riga di Google spreadsheet
...
* \ |LINK104|\  il mio genratore di feed RSS

* \ |LINK105|\  - \ |LINK106|\  per costruire Feed per gli eventi Feltrinelli di Palermo
...
* \ |LINK114|\  — si tratta di un altro servizio Web gratuito e che non necessita di registrazione e permette di intervenire sui documenti PDF unendoli, oltre che convertendoli, dividendoli, alleggerendoli, sbloccandoli ecc. Non applica limitazioni per quel che concerne il peso massimo dei file.

* \ |LINK115|\  — è un’altra soluzione per unire i file PDF via Web e tramite la quale è eventualmente possibile apportare varie ulteriori modifiche ai documenti caricati. È gratis, non richiede registrazione e non pone limiti per l’upload.

\ |STYLE10|\ 

\ |STYLE11|\ . Si tratta, infatti, di un’app che consente di visualizzare i file PDF e intervenire su di essi in vari modi, andandoli a convertire, unire ecc. È gratuita e facile da usare. Per effettuarne il download sul tuo dispositivo, accedi alla \ |LINK116|\ 
...
:guilabel:`Queste ed altre indicazioni per Read the Docs si tovano anche a` \ |LINK118|\  
...
:download:\`Questo link è per il download <\ |LINK119|\ >\`.

si scrive così: ``:download:`Questo link è per il download <\ |LINK120|\ >```
