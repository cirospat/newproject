...
:guilabel:`trovare la pagina esatta in un pdf online`: nel web è \ |LINK3|\  cioè dopo :class:`.pdf` digitare :class:`.#page=4` dove dopo :class:`=` si scrive il numero della pagina che si vuole venga visualizzata direttamente all'apertura del file ``pdf`` online
...
+-------------------------------------------------+------------------------------------------------------------------------------------------+
|icone material design Google                     |\ |LINK4|\                                                                                |
+-------------------------------------------------+------------------------------------------------------------------------------------------+
|webservice per la trascrizione testuale di audio |\ |LINK5|\                                                                                |
|                                                 |                                                                                          |
|con plugin per chrome                            |\ |LINK6|\                                                                                |
|                                                 |                                                                                          |
+-------------------------------------------------+------------------------------------------------------------------------------------------+
|\ |STYLE0|\  funzioni su Fogli Google spreadsheet|\ |LINK7|\                                                                                |
+-------------------------------------------------+------------------------------------------------------------------------------------------+
|Markup Validation Service                        |\ |LINK8|\                                                                                |
+-------------------------------------------------+------------------------------------------------------------------------------------------+
|Web accessibility Contrast Checker               |\ |LINK9|\                                                                                |
+-------------------------------------------------+------------------------------------------------------------------------------------------+
|Web Developer Toolbar Chrome                     |\ |LINK10|\                                                                               |
+-------------------------------------------------+------------------------------------------------------------------------------------------+
|Accessibility of a PDF Document                  |\ |LINK11|\                                                                               |
+-------------------------------------------------+------------------------------------------------------------------------------------------+
...
* \ |LINK14|\  my google maps

* \ |LINK15|\  (pagina FB con mappe su Palermo)

* \ |LINK16|\  (mappe varie di Ciro)

* \ |LINK17|\  (contenitore di oltre 100 mappe su Palermo, su Petrusino)

* \ |LINK18|\  (sito mappe di Palermo utili a turisti)

* \ |LINK19|\  (OMIRA su Umap cirospat) 

* \ |LINK20|\  elezioni2017_Palermo da Guenter Richter

* \ |LINK21|\  e relativo bot telegram #rifiutocivico

* \ |LINK22|\  mapillary cirospat

* \ |LINK23|\  Palermo su mapillary

* \ |LINK24|\  Palermo airbnb gen_2018 (Gianni Vitrano)
...
* \ |LINK25|\  (GBVitrano Palermo IGM 1:25000)

* \ |LINK26|\  carta tecnica comune Palermo

* \ |LINK27|\  (GBVitrano Omira 1:5000)

* \ |LINK28|\   PRG2025 (su Petrusino)

* \ |LINK29|\  (elenco mappe 2-3D di GBVitrano su Github SiciliaHub)

* \ |LINK30|\   (Hubsicilia - Omira Irta e Sas con OSM e RealVista su Gitub SiciliaHub, con metadati mappa su barra laterale)

* \ |LINK31|\  (variante general eal PRG 2004 con cerchio)

* \ |LINK32|\  (catasto centro storico 1887 con cerchio)

* \ |LINK33|\  (PRG scehma masima su PRG 2004 con cerchio)

* \ |LINK34|\    \ |LINK35|\    (Piano protezione civile Palermo)

* \ |LINK36|\   (stile petrusino)

* \ |LINK37|\   (stile petrusino, ultimo gen 2018) - hub di diverse mappe di Palermo a cura di GBVitrano iniziato gli ultimi giorni di dic. del 2017
...
\ |LINK38|\  (che preferisco) 

\ |LINK39|\  (intramontabile) 

\ |LINK40|\  (questo però è un plugin per wordpress) 
...
The \ |LINK44|\  function converts it to the required format for the Query formula by specifying a format of "yyyy-mm-dd":
...
* lista di tiles per sfondi   \ |LINK46|\  

* tiles vari da usare  \ |LINK47|\  

* satellite tile ESRI - World Imagery \ |LINK48|\  

* satellite tile Google \ |LINK49|\  

* tile con sfondo satellite da mapbox/satellite-v9 con API: \ |LINK50|\   (senza nomi strade)

* \ |LINK51|\  (con nomi strade)

* SERVIZIO ONLINE CREAZIONE DI TILES DA IMMAGINI  Mapwarper \ |LINK52|\  

* \ |LINK53|\  tile: https://api.mapbox.com/styles/v1/rplln/cjix2cv5l83yz2rmne9icvusx/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoicnBsbG4iLCJhIjoiY2ppeDI5ZTByMDVtMzN1cDRxZWlzamwzcyJ9.Yn6OjT0SStL2tffNloZrdg
...
video embedding = {{{\ |LINK54|\ }}}

link con testo = [[\ |LINK55|\ |testo del link]] 

immagine = {{\ |LINK56|\ |larghezza}} Immagine 

link a url con icona cliccabile = [[\ |LINK57|\ }}]]

ICONE MAPPE = \ |LINK58|\  

GOOGLEMAPS = <iframe width='100%' height='500' src="http....   "></iframe>

URL ENCODER E DECODER = \ |LINK59|\  

POST IMAGE DA LINKARE SU UMAP: \ |LINK60|\  

Icone mappe \ |LINK61|\  ccbysa
...
Video breve per alimentare in modo facile uMap da un foglio elettronico su Google Drive, by Andrea Borruso \ |LINK62|\ 

Tutorial per fare mappe alimentate da google spreadsheet = \ |LINK63|\  
...
.. _h1d7696518113b7119116124c2f3267:

\ |LINK64|\  e \ |LINK65|\  UMAP AVVISI POLIZIA MUNICIPALE PA - VISUALIZZARE MAPPE CON INFO SU DATA ODIERNA
-----------------------------------------------------------------------------------------------------------
...
⇒ \ |LINK66|\  plug in come componente aggiuntivo da installare su spreadsheet di Google. Sfrutta API di Google e quindi i dati delle coordinate geografiche sono riusabili solo su mappe Google.
...
dove A2 è la colonna dove è contenuto l'indirizzo. \ |LINK67|\ .


|REPLACE7|

* \ |LINK68|\  con Openstreetmap tramite OnData

* \ |LINK69|\   con Openstreetmap

* \ |LINK70|\  con Openstreetmap

* \ |LINK71|\  con Openstreetmap

* \ |LINK72|\  con Googlemap

* \ |LINK73|\  by GBVitrano con API Google

* \ |LINK74|\  by GBVitrano con API Google

* \ |LINK75|\  con le API di Google

    * \ |LINK76|\  con API Google

* \ |LINK77|\  (google e bing) 

* \ |LINK78|\  con API di Mapquest

* \ |LINK79|\  API Mapquest per geocoding (cirospat - caneclaudia2volte)

* \ |LINK80|\  location helper in versione demo di Mapbox
...
* \ |LINK82|\  (mappa con grafici e dati su sensore mio)
...
just a simple guide for getting started with git. \ |LINK83|\ 
...
\ |LINK86|\  un articolo per capire un po

\ |LINK87|\  corso online strutturato bene per utenti con nozioni zero di intelligenza artificiale
...
* \ |LINK89|\  editor online sulla falsa riga di Google spreadsheet
...
* \ |LINK96|\  il mio genratore di feed RSS

* \ |LINK97|\  - \ |LINK98|\  per costruire Feed per gli eventi Feltrinelli di Palermo
...
* PDFTK Builder \ |LINK103|\  

* Online2PDF \ |LINK104|\  

* \ |LINK105|\  — servizio Web gratuito e che non richiede registrazioni. Permette di unire e modificare i file PDF in vari modi. Da notare che non consente di caricare file aventi un peso superiore ai 100 MB. Eventualmente, però, è possibile aggirare questa limitazione passando a uno dei piani a pagamento (con costi a partire da 6 euro/mese), i quali consentono di sbloccare anche altre funzionalità extra.

* \ |LINK106|\  — si tratta di un altro servizio Web gratuito e che non necessita di registrazione e permette di intervenire sui documenti PDF unendoli, oltre che convertendoli, dividendoli, alleggerendoli, sbloccandoli ecc. Non applica limitazioni per quel che concerne il peso massimo dei file.

* \ |LINK107|\  — è un’altra soluzione per unire i file PDF via Web e tramite la quale è eventualmente possibile apportare varie ulteriori modifiche ai documenti caricati. È gratis, non richiede registrazione e non pone limiti per l’upload.

\ |STYLE10|\ 

\ |STYLE11|\ . Si tratta, infatti, di un’app che consente di visualizzare i file PDF e intervenire su di essi in vari modi, andandoli a convertire, unire ecc. È gratuita e facile da usare. Per effettuarne il download sul tuo dispositivo, accedi alla \ |LINK108|\ 
...
:guilabel:`Queste ed altre indicazioni per Read the Docs si tovano anche a` \ |LINK110|\  
...
:download:\`Questo link è per il download <\ |LINK111|\ >\`.

si scrive così: ``:download:`Questo link è per il download <\ |LINK112|\ >```
